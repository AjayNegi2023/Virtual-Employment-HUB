                        ...
                        <div className='w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  '>
                            ...
                            <div className='flex items-center  justify-center w-full py-10'>
                                <div className='flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center'>
                                    <div className='flex mb-1 items-center justify-center'>
                                        <Image src={JobDetails?.company_logo_url} alt="no-image" className='rounded-full mb-2' width={100} height={100} />
                                    ...
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center'>
                                        <div className='flex items-center justify-center mb-1'>
                                            ...
                                            <p className=' text-sm text-gray-800 mx-1'>{JobDetails?.company}</p>
                                        </div>
                                        <div className='flex items-center justify-center mb-1'>
                                    ...
                                    <div className='md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center'>
                                        ...
                                        <div className='flex items-center justify-center mb-1'>
                                            ...
                                            <p className=' text-sm text-gray-800 mx-1'> {JobDetails?.salary!==0 ?  JobDetails?.salary+" LPA"  : "Not Disclosed"}</p>
                                        </div>
                                    </div>
                                    <div className='flex items-center justify-center'>
                                        {
                                            JobDetails?.user?.email === user?.email ? (
                                                ...
                                                <div className='flex items-center justify-center  '>
                                                    ...
                                                    <button onClick={() => window.open(JobDetails?.job_url, '_blank')} className='md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-indigo-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-indigo-900 text-white'>Apply Position</button>
                            ...
                            <div className='w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center'>
                                <div className='md:w-8/12 w-full md:px-4 py-8 flex flex-col items-center content-start justify-center '>
                                    ...
                                    <p className='px-4 whitespace-pre-wrap'>{JobDetails?.description}</p>
                                </div>
